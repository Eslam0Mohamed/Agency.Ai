...
const OurLatesetWork = () => {
    ...
    return (
        <motion.div
            ...
            viewport={{ once: true }}
            id='our-work' className='pt-20 flex flex-col items-center justify-center mx-auto px-4
            ...
            <div className='grid sm"grid-cols-2 lg:grid-cols-3 gap-6 w-full'>
                {
                    workData.map((work, index) => {
                        return <motion.div
                            ...
                            viewport={{ once: true }}
                            className=' hover:scale-105 duration-500 transition-all cursor-pointer' key={index}>
